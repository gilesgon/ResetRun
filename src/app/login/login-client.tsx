  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-10">
      <div className="mx-auto max-w-md">
        ...
        <p className="text-white/50 mt-2">Sign in to save your setup across devices (cloud sync coming soon).</p>

        <div className="mt-10 space-y-4">
          <button onClick={loginWithGoogle} className="w-full rounded-2xl py-4 font-bold bg-white text-black">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              >
                {emailMode === 'signup' ? 'Already have an account? Sign in' : 'Need an account? Create one'}
              </button>
            </div>
          </div>
